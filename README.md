...
- 新增记录图片能力：支持在新增/编辑记录时上传备注图片，记录项支持缩略图与大图预览。
- 优化首页餐次分组规则：早餐调整为 4:00 起，22:00-4:00 自动归类为宵夜。
- 升级首页分享导出：由普通截图改为精美长图生成，完整展示当日分组记录、统计卡片与状态信息。
- 优化分享长图视觉：支持随机主题背景、半透明圆角卡片、淡阴影、品牌化页脚与更稳定的排版。
- 增强分享细节：导出图支持按设置显示宏量营养（碳水/蛋白质/脂肪），记录卡片优先显示用户上传缩略图，且去除备注文本以保持简洁。
- 升级备份机制：数据备份/恢复改为 zip 方案并包含图片资源，提升迁移完整性。
- 新增运动与记录交互优化：完善首页分组展示、编辑入口与分享流程，修复保存/分享相关稳定性问题。
<img src="images/8e98d1018f527bc363492ab613b34ea4.jpg" width="393" />
